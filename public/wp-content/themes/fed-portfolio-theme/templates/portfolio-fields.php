...
<label for="tech-meta-box">Technologies</label><br> <input id="tech-meta-box" type="text" name="technologies" maxlength="100" value="<?php echo get_post_meta($post->ID, 'technologies', true) ?>"><br>
